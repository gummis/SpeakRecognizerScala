...
public class ViterbiCalculatorTemplate {
	/*
	 ...
	 */
	public <O extends Observation> ViterbiCalculatorTemplate(
	 ...
	 */
	private <O extends Observation> void computeStep(Hmm<O> hmm, O o, int t,
			int j) {
